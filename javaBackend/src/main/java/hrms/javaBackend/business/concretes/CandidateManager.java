...
public class CandidateManager implements CandidateService {
	...
	public Result add(Candidate candidate) {
		...
		boolean checkUserRealOrNot = !this.checkIfRealPerson(candidate.getIdentityNumber(), candidate.getFirstName(), candidate.getLastName(), candidate.getBirthDate()).getData();
		...
		if(mernis == false) {
			...
			return new SuccessResult(emailService.sendEmail(candidate).getMessage());
		}
